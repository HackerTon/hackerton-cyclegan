...
def resi_block(input_layer, k):
    ...
    d2_block = tf.keras.layers.Conv2D(
        k, (3, 3), (1, 1), padding='same',
        kernel_initializer=kernel_initializer)(d_block)
...
def generator():
    ...
    conv3 = tf.keras.layers.Conv2D(
        256, (3, 3), 2, padding='same', kernel_initializer=kernel_initializer)(conv2)
    ...
    deconv2 = tf.keras.layers.Conv2DTranspose(
        ...
        kernel_initializer=kernel_initializer)(deconv1)
